  ...
  return (
    <>
        ...
        <div className="min-h-screen flex flex-col items-center justify-center p-4 md:p-8">
          ...
          <div className="bg-miamiBlue w-full mt-8 md:w-3/4 lg:w-3/4 rounded-lg shadow-md p-4 md:p-8">
            <div className="mb-4">
              ...
              <p>
                Project lead for several multidisciplinary teams working at retail sector projects.
                I took care that projects were delivered from idea to production ready products
                ...
                Devops, Azure Data Factory Cypress, Terraform, Docker, Git, Jira, Project
              ...
              <p>
                Frontend web developer in an automation industry project. Member of a small team
                part of a big multivendor delivery organisation consisting of multiple teams
                creating one large scale product. Work focusing on web frontend development,
                refactoring and driving technology changes and culture forward.
                <br />
                <br />
                <strong>Skills:</strong> NodeJS, React, Backbone/MarionetteJS, JavaScript,
                TypeScript, Robot framework, Jenkins, Git, Jira, Scrum, Agile
              </p>
            </div>
          </div>
          <div className="bg-miamiBlue w-full mt-8 md:w-3/4 lg:w-3/4 rounded-lg shadow-md p-4 md:p-8">
            <div className="mb-4">
              ...
              <p>
                ...
                Participating in all software development phases from specification to maintenance
                and customer support. I worked on multiple desktop and web applications and acquired
                solid developer skills growing from a junior to senior mentoring others. Acted also
                as a product owner for one delivery project gaining valuable knowledge of product
                creation process.
                <br />
                <br />
                <strong>Skills:</strong> NodeJS, NextJS, React, Typescript, CSS, GraphQL, Contentful
      ...
      <footer className="bottom-0 left-0 w-full flex items-center justify-center">
        <span className="text-center text-white text-sm pb-2">
          koodalanne Oy, 3396808-5,

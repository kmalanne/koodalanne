...
export default function Home() {
  return (
    <main>
      <section
        id="who-am-i"
        className="md:flex md:justify-center md:items-center md:flex-row md:min-h-screen md:pb-8 bg-black"
      >
        <div className="min-h-screen flex justify-center items-center">
          <div>
            <div className="flex justify-left h-14 lg:hidden mb-8">
              <div className="">
                <Image
                  alt="Profile picture of Kai-Mikael Alanne"
            ...
            <div className={pressStart2P.className}>
              <h1 className="text-4xl md:text-5xl text-miamiPink">foobarbar</h1>
            </div>
            <p className="my-12 text-xl text-white">
              ...
              <div className="flex flex-col justify-center items-center ml-6">
                ...
                >
                  <svg
                    ...
                    viewBox="0 0 496 512"
                  >
                    <title id="svg-github">My Github</title>
                    <path
                      fill="#fff"
                ...
                >
                  <svg
                    ...
                    viewBox="0 0 448 512"
                  >
                    <title id="svg-linkedin">My LinkedIn</title>
                    <path
                      fill="#fff"
        ...
        <div className="lg:flex lg:justify-center lg:items-center hidden lg:w-2/5 ml-2">
          <Image
            alt="Large profile picture of Kai-Mikael Alanne"
            src="/images/face.jpeg"
            width={500}
            height={500}
            className="rounded-full"

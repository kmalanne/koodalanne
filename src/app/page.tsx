  ...
  return (
    <>
      <main>
        <section
          id="who-am-i"
          className="md:flex md:justify-center md:items-center md:flex-row md:min-h-screen bg-black"
        >
          <div className="min-h-screen flex justify-center items-center px-4">
            <div>
              ...
              <p className="my-12 text-xl text-white">
                Freelance senior/lead developer for hire.
                <br />
              ...
              <div className="flex flex-row justify-center items-center">
                ...
                <div className="flex flex-col justify-center items-center ml-6">
                  <a
                    ...
                    aria-label="Kai-Mikael Alanne Github"
                  ...
                  <a
                    className="w-5 h-5 mt-2 mb-2 opacity-75 transform hover:scale-110 hover:opacity-100"
                    aria-label="Kai-Mikael Alanne LinkedIn"
